# Facilitator Guide: Adding Gas Free Payments

This guide explains how to integrate Circle Gateway into your x402 facilitator to offer **gas free, batched payments** alongside your existing settlement methods.
...
1.  **Gas Free Payments**: Enable buyers to pay by signing messages, not transactions.
...
Once you integrate Gateway, it becomes effortless for your sellers to support gas free payments. They simply connect to your facilitator as usual, and **automatically** gain access to both standard and gas free payment options.
...
## Option: Gas Free-Only Facilitator

If you are building a new facilitator and only want to support gas free payments (without immediate on-chain settlement), integration is even simpler. You can use `BatchFacilitatorClient` directly with `x402ResourceServer`.
